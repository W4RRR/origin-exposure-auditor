...
def _upgrade_from_github() -> None:
    ...
    typer.echo("Upgrading origin-audit from GitHub...")
    try:
    ...
    typer.echo("Upgrade complete. Run 'origin-audit version' to verify the installation.")
...
def scan(
    ...
    active_validate: Annotated[
        bool,
        typer.Option("-active", "--active-validate", help="Enable scope-gated active validation."),
    ] = False,
